...
class Product {
    ...
    public function update() {
        ...
        try {
            ...
            $stmt = $pdo->prepare("UPDATE product SET name = ?, photos = ?, price = ?, description = ?, quantity = ?, category_id = ?, updatedAt = ? WHERE id = ?");
            ...
            $stmt->execute([$name, $photos, $price, $description, $quantity, $category_id, $updatedAt, $id]);
